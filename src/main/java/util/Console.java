...
public class Console {
    ...
    public void print(Object obj, boolean fieldsReading) {if (!exeStatus || !fieldsReading) print(obj);}
    public void println(Object obj) {System.out.println(obj);}
    public void printAnswer(Object answer) {System.out.println("\n" + answer);}
    ...
    public boolean getExeStatus() {return exeStatus;}
    public void setBufferedReader(BufferedReader bufferedReader) {this.bufferedReader = bufferedReader;}
    public void setExeStatus(boolean exeStatus) {this.exeStatus = exeStatus;}
}
